...
@OnlyIn(Dist.CLIENT)
public class MoltenCreeperModel<T extends Entity> extends SegmentedModel<T>
{
	// Molten Creeper model class. Exact copy of vanilla Creeper model with extremely few edits, because why fix what isn't broken
	
	private final ModelRenderer head;
	private final ModelRenderer creeperArmorMolten;
	...
	public MoltenCreeperModel()
	{ this(0.0F); }
	
	@SuppressWarnings("unused")
	public MoltenCreeperModel(float p_i46366_1_)
	{
		int i = 6;
		this.head = new ModelRenderer(this, 0, 0);
		this.head.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, p_i46366_1_);
		this.head.setRotationPoint(0.0F, 6.0F, 0.0F);
		this.creeperArmorMolten = new ModelRenderer(this, 32, 0);
		this.creeperArmorMolten.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, p_i46366_1_ + 0.5F);
		this.creeperArmorMolten.setRotationPoint(0.0F, 6.0F, 0.0F);
