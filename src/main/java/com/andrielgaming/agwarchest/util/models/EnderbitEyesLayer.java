...
{
	private static final RenderType RENDER_TYPE = RenderType.getEyes(new ResourceLocation(WarchestMaster.MOD_ID, "textures/entities/enderbit/enderbit_eyes.png"));
