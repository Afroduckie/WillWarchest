...
public class EnderbitModel<T extends LivingEntity> extends BipedModel<T>
{
	...
	public EnderbitModel(float scale)
	{
		...
		this.bipedHeadwear.setRotationPoint(0.0F, 14.5F, 0.0F);
		this.bipedHeadwear.setTextureOffset(0, 16).addBox(-4.0F, 4.5F, -4.0F, 8.0F, 8.0F, 8.0F, scale - 0.5F);
		...
		this.secondRightArm.setRotationPoint(-1.0F, 2.0F, 0.0F);
		this.secondRightArm.setTextureOffset(56, 0).addBox(-1.0F, 8.0F, -1.0F, 2.0F, 9.0F, 2.0F, scale);
		this.bipedBody.addChild(this.secondRightArm);*/
		...
		this.secondLeftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		this.secondLeftArm.setTextureOffset(56, 0).addBox(-1.0F, 8.0F, -1.0F, 2.0F, 9.0F, 2.0F, scale);
		this.bipedBody.addChild(this.secondLeftArm);*/
