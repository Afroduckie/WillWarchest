...
public class EnderbitModel<T extends LivingEntity> extends BipedModel<T>
{
	...
	public EnderbitModel(float scale)
	{
		...
		this.bipedRightArm.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 10.0F, 2.0F, scale);
		this.bipedRightArm.setRotationPoint(-3.0F, -12.0F, 0.0F);
		this.bipedLeftArm = new ModelRenderer(this, 56, 0);
		this.bipedLeftArm.mirror = true;
		this.bipedLeftArm.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 10.0F, 2.0F, scale);
		this.bipedLeftArm.setRotationPoint(5.0F, -12.0F, 0.0F);
		this.bipedRightLeg = new ModelRenderer(this, 56, 0);
		this.bipedRightLeg.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, scale);
		this.bipedRightLeg.setRotationPoint(-2.0F, -2.0F, 0.0F);
		this.bipedLeftLeg = new ModelRenderer(this, 56, 0);
		this.bipedLeftLeg.mirror = true;
		this.bipedLeftLeg.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, scale);
