...
@OnlyIn(Dist.CLIENT)
public class EnderbitHeldBlockLayer extends LayerRenderer<Enderbit, EnderbitModel<Enderbit>>
{
	public EnderbitHeldBlockLayer(IEntityRenderer<Enderbit, EnderbitModel<Enderbit>> p_i50949_1_)
	{ super(p_i50949_1_); }

	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, Enderbit entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
	{
