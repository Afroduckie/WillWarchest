...
{
	// Mostly a direct copy of the Creeper's vanilla renderer.
	// No functions currently deprecated! So that's a plus.
	// Adds a function that will render violent shaking when
	// 	the molten creeper is about to detonate
