...
public class Enderbit extends MonsterEntity implements IAngerable
{
	...
	private static final DataParameter<Optional<BlockState>> CARRIED_BLOCK = EntityDataManager.createKey(Enderbit.class, DataSerializers.OPTIONAL_BLOCK_STATE);
	private static final DataParameter<Boolean> SCREAMING = EntityDataManager.createKey(Enderbit.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> field_226535_bx_ = EntityDataManager.createKey(Enderbit.class, DataSerializers.BOOLEAN);
	...
	public Enderbit(EntityType<? extends Enderbit> type, World worldIn)
	{
		super(type, worldIn);
	...
	protected void registerGoals()
	{
		...
		//this.goalSelector.addGoal(1, new Enderbit.StareGoal(this));
		this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.0D, false));
		this.goalSelector.addGoal(7, new WaterAvoidingRandomWalkingGoal(this, 1.0D, 0.0F));
		this.goalSelector.addGoal(8, new LookAtGoal(this, PlayerEntity.class, 8.0F));
		this.goalSelector.addGoal(8, new LookRandomlyGoal(this));
		//this.goalSelector.addGoal(10, new Enderbit.PlaceBlockGoal(this));
		//this.goalSelector.addGoal(11, new Enderbit.TakeBlockGoal(this));
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, PlayerEntity.class, 10, true, false, this::func_233680_b_));
		//this.targetSelector.addGoal(2, new Enderbit.FindPlayerGoal(this));
	...
	public void setAttackTarget(@Nullable LivingEntity entitylivingbaseIn)
	{
		...
		super.setAttackTarget(entitylivingbaseIn); // Forge: Moved down to allow event handlers to write data manager
													// values.
	}
	...
	{
		private final Enderbit enderman;
		/** The player */
		...
		public FindPlayerGoal(Enderbit endermanIn)
		{
