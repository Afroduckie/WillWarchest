...
public class MoltenCreeperEntity extends MonsterEntity implements IChargeableMob 
{
   ...
   //private int droppedSkulls;  <- TODO
   ...
   {
         FluidExplosion.Mode explosion$mode = this.isCharged() ? FluidExplosion.Mode.LAVA : FluidExplosion.Mode.FIRE;//net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this) ? FluidExplosion.Mode.LAVA : FluidExplosion.Mode.NONE;
